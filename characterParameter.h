...
static const StatusData statusdatabase[] = {
    {0,"warrior", 40, 3, 30, 10, 15, 15, 5, 1, 0},
    {1,"hunter", 30, 10, 20, 5, 18, 20, 10, 3, 0},
    {2,"priest", 10, 50, 5, 3, 10, 15, 20, 1,  0},
    {3,"sorcerer", 15, 50, 5, 3, 10, 15, 20, 7, 0},
    {4,"monk", 50, 10, 20, 8, 20, 25, 5, 1, 0}
    {5,"オーク",26,0,10,3,0,0,0,0, 1},
    {6,"ゴブリン",20,0,10,3,0,0,0,0, 1},
    {7,"グリーンスライム",18,0,10,3,0,0,0,0, 1},
